...
public class AnalysisIpSources {
	...
	public static void main(String[] args){
		...
		System.out.println("-->>Mapping large files into small files, end. Total time cost��" + getMS(startTime) + " millisecond");  
		...
		System.out.println("-->>Total time cost��" + getMS(startTime) + "millisecond");  
